...
export default function ThankYou() {
  return (
    <div className="pt-24 min-h-screen flex items-center justify-center bg-brand-bg py-20 relative">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          <h4 className="text-[10px] uppercase tracking-[0.3em] font-bold text-gray-400 mb-4">Submission Complete</h4>
          <h1 className="text-4xl md:text-5xl font-serif text-brand-navy mb-6">Thank You!</h1>
